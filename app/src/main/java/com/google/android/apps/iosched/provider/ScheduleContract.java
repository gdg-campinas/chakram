...
public class ScheduleContract {
    ...
    /**
     * Special value for {@link com.google.android.apps.iosched.provider.ScheduleContract.SyncColumns#UPDATED} indicating that an entry
     * has never been updated, or doesn't exist yet.
     */
    public static final long UPDATED_NEVER = -2;

    /**
     * Special value for {@link com.google.android.apps.iosched.provider.ScheduleContract.SyncColumns#UPDATED} indicating that the last
    ...
    /**
     * Blocks are generic timeslots that {@link com.google.android.apps.iosched.provider.ScheduleContract.Sessions} and other related
     * events fall into.
     */
    public static class Blocks implements BlocksColumns, BaseColumns {
        ...
        /** Count of {@link com.google.android.apps.iosched.provider.ScheduleContract.Sessions} inside given block. */
         ...
         * {@link com.google.android.apps.iosched.provider.ScheduleContract.Sessions#SESSION_STARRED} set.
         */
         ...
         * {@link com.google.android.apps.iosched.provider.ScheduleContract.Sessions#SESSION_LIVESTREAM_URL} set.
         */
        public static final String NUM_LIVESTREAMED_SESSIONS = "num_livestreamed_sessions";

        /**
         * The {@link com.google.android.apps.iosched.provider.ScheduleContract.Sessions#SESSION_ID} of the first starred session in this
         * block.
         */
        public static final String STARRED_SESSION_ID = "starred_session_id";

        /**
         * The {@link com.google.android.apps.iosched.provider.ScheduleContract.Sessions#SESSION_TITLE} of the first starred session in
         * this block.
         */
        public static final String STARRED_SESSION_TITLE = "starred_session_title";

        /**
         * The {@link com.google.android.apps.iosched.provider.ScheduleContract.Sessions#SESSION_LIVESTREAM_URL} of the first starred
        ...
        /**
         * The {@link com.google.android.apps.iosched.provider.ScheduleContract.Rooms#ROOM_NAME} of the first starred session in this
         * block.
         */
        public static final String STARRED_SESSION_ROOM_NAME = "starred_session_room_name";

        /**
         * The {@link com.google.android.apps.iosched.provider.ScheduleContract.Rooms#ROOM_ID} of the first starred session in this block.
         */
        public static final String STARRED_SESSION_ROOM_ID = "starred_session_room_id";

        /**
         * The {@link com.google.android.apps.iosched.provider.ScheduleContract.Sessions#SESSION_HASHTAGS} of the first starred session in
         * this block.
         */
        public static final String STARRED_SESSION_HASHTAGS = "starred_session_hashtags";

        /**
         * The {@link com.google.android.apps.iosched.provider.ScheduleContract.Sessions#SESSION_URL} of the first starred session in this
         * block.
         */
        ...
        /**
         * Build {@link android.net.Uri} that references any {@link com.google.android.apps.iosched.provider.ScheduleContract.Sessions} associated
        ...
        /**
         * Build {@link android.net.Uri} that references starred {@link com.google.android.apps.iosched.provider.ScheduleContract.Sessions} associated
         * with the requested {@link #BLOCK_ID}.
         */
        ...
        /** Read {@link #BLOCK_ID} from {@link com.google.android.apps.iosched.provider.ScheduleContract.Blocks} {@link android.net.Uri}. */
         ...
         * {@link com.google.android.apps.iosched.provider.ScheduleContract.Blocks} details.
         */
    ...
    /**
     * Tracks are overall categories for {@link com.google.android.apps.iosched.provider.ScheduleContract.Sessions} and {@link com.google.android.apps.iosched.provider.ScheduleContract.Sandbox},
    ...
    public static class Tracks implements TracksColumns, BaseColumns {
        ...
        /** Count of {@link com.google.android.apps.iosched.provider.ScheduleContract.Sessions} inside given track that aren't office hours. */
        public static final String SESSIONS_COUNT = "sessions_count";
        /** Count of {@link com.google.android.apps.iosched.provider.ScheduleContract.Sessions} inside given track that are office hours. */
        ...
        /** Read {@link #TRACK_ID} from {@link com.google.android.apps.iosched.provider.ScheduleContract.Tracks} {@link android.net.Uri}. */
    ...
    public static class Rooms implements RoomsColumns, BaseColumns {
        ...
        /** Read {@link #ROOM_ID} from {@link com.google.android.apps.iosched.provider.ScheduleContract.Rooms} {@link android.net.Uri}. */
    ...
    /**
     * Each session is a block of time that has a {@link com.google.android.apps.iosched.provider.ScheduleContract.Tracks}, a
     * {@link com.google.android.apps.iosched.provider.ScheduleContract.Rooms}, and zero or more {@link com.google.android.apps.iosched.provider.ScheduleContract.Speakers}.
     */
    ...
    public static class Feedback implements BaseColumns, FeedbackColumns, SyncColumns {
        ...
        /** Read {@link #SESSION_ID} from {@link com.google.android.apps.iosched.provider.ScheduleContract.Feedback} {@link android.net.Uri}. */
    ...
    public static class Sessions implements SessionsColumns, BlocksColumns, RoomsColumns,
        ...
        /**
         * Build {@link android.net.Uri} that references any {@link com.google.android.apps.iosched.provider.ScheduleContract.Speakers} associated
        ...
        /**
         * Build {@link android.net.Uri} that references any {@link com.google.android.apps.iosched.provider.ScheduleContract.Tracks} associated with
        ...
        /** Read {@link #SESSION_ID} from {@link com.google.android.apps.iosched.provider.ScheduleContract.Sessions} {@link android.net.Uri}. */
        public static String getSessionId(Uri uri) {
            return uri.getPathSegments().get(1);
        }
    ...
    /**
     * Speakers are individual people that lead {@link com.google.android.apps.iosched.provider.ScheduleContract.Sessions}.
     */
    public static class Speakers implements SpeakersColumns, SyncColumns, BaseColumns {
        ...
        /** Read {@link #SPEAKER_ID} from {@link com.google.android.apps.iosched.provider.ScheduleContract.Speakers} {@link android.net.Uri}. */
     ...
     * associated with a specific {@link com.google.android.apps.iosched.provider.ScheduleContract.Tracks} and time block.
     */
    public static class Sandbox implements SandboxColumns, SyncColumns, BlocksColumns, RoomsColumns, BaseColumns {
        ...
        /** {@link com.google.android.apps.iosched.provider.ScheduleContract.Tracks#TRACK_ID} that this sandbox company belongs to. */
    ...
    public static class Announcements implements AnnouncementsColumns, BaseColumns {
        ...
        /**
         * Read {@link #ANNOUNCEMENT_ID} from {@link com.google.android.apps.iosched.provider.ScheduleContract.Announcements} {@link android.net.Uri}.
         */
    ...
    public static class MapTiles implements MapTileColumns, BaseColumns {
        ...
        /** Read floor from {@link com.google.android.apps.iosched.provider.ScheduleContract.MapMarkers} {@link android.net.Uri}. */
    ...
    public static class MapMarkers implements MapMarkerColumns, BaseColumns {
        ...
        /** Read {@link #MARKER_ID} from {@link com.google.android.apps.iosched.provider.ScheduleContract.MapMarkers} {@link android.net.Uri}. */
        public static String getMarkerId(Uri uri) {
            return uri.getPathSegments().get(1);
        }

        /** Read {@link #FLOOR} from {@link com.google.android.apps.iosched.provider.ScheduleContract.MapMarkers} {@link android.net.Uri}. */
